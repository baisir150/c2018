...
public class LZ77 {
    ...
    private String OriginalPath = "resource/OriginalText.txt";
    private String CompressPath = "resource/CompressedText.txt";
    private String DecompressPath = "resource/DecompressedText.txt";
    String content = "";
